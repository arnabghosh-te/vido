      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {plans.map((plan) => (
              <div key={plan.id} className="bg-white rounded-lg shadow-lg divide-y divide-gray-200 flex flex-col">
                <div className="p-6 flex-1">
                  <h3 className="text-2xl font-semibold text-gray-900 text-center">{plan.name}</h3>
                  <p className="mt-4 text-gray-500 text-sm text-center h-12">{plan.description}</p>
                  <p className="mt-8 text-center">
                    <span className="text-4xl font-extrabold text-gray-900">${plan.price}</span>
                    <span className="text-base font-medium text-gray-500">/{plan.durationInDays} days</span>
                  </p>
                  <ul className="mt-8 space-y-4">
                    <li className="flex items-start">
                      ...
                      <p className="ml-3 text-base text-gray-700">{plan.tokensIncluded} Tokens included</p>
                    </li>
                    <li className="flex items-start">
                      <div className="flex-shrink-0">
                        <svg className="h-6 w-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
